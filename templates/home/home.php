    ...
    <div class="content">
        <div class="row row-deck">
            <div class="col-sm-6 col-xxl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="fs-3 fw-bold" id="lbl_total_reports">0</dt>
                            <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0"><?php echo __('Total Reports');?></dd>
                        </dl>
            ...
            <div class="col-sm-6 col-xxl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="fs-3 fw-bold" id="lbl_pending_reports">0</dt>
                            <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0"><?php echo __('Pending Reports');?></dd>
                        </dl>
                        <div class="item item-rounded-lg bg-body-light">
                            <i class="fa fa-list fs-3 text-primary"></i>
                        </div>
                    </div>
                </div>
                <!-- END New Customers -->
            ...
            <div class="col-sm-6 col-xxl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="fs-3 fw-bold" id="lbl_working_closed">0/0</dt>
                            <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0"><?php echo __('Working/Closed Reports');?></dd>
                        </dl>
                        <div class="item item-rounded-lg bg-body-light">
                            <i class="fa fa-list fs-3 text-primary"></i>
                        </div>
            ...
            <div class="col-sm-6 col-xxl-3">
                ...
                <div class="block block-rounded d-flex flex-column">
                    <div class="block-content block-content-full flex-grow-1 d-flex justify-content-between align-items-center">
                        <dl class="mb-0">
                            <dt class="fs-3 fw-bold" id="lbl_reporters">0</dt>
                            <dd class="fs-sm fw-medium fs-sm fw-medium text-muted mb-0"><?php echo __('Total Reporters');?></dd>
                        </dl>
                        <div class="item item-rounded-lg bg-body-light">
        ...
        <div class="block block-rounded">
            ...
            <div class="block-content fs-sm">
                <table class="table table-hover table-vcenter table-responsive" style="width: 100%" id="tbl_pending_reports">
                    <thead>
                    <th>#</th>
